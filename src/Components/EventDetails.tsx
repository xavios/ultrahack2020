...
const EventDetails: FC<EventDetailProps> = (props): ReactElement => {
  ...
  return (
    <div>
          ...
          <li
            className={
              state.selectedTab === "basic"
                ? "breadcrumb-item breadcrumb-selected"
                : "breadcrumb-item"
            }
            onClick={() => onBreadCrumbClick("basic")}
          >
            Event information
          </li>
          <li
            className={
              state.selectedTab === "participants"
                ? "breadcrumb-item breadcrumb-selected"
                : "breadcrumb-item"
            }
            onClick={() => onBreadCrumbClick("participants")}
          >
            Manage participants
          </li>
        </ol>
      ...
      {state.selectedTab === "basic" && (
        <BasicEventData event={props.event} onBackClick={props.onBackClick} />
      )}
      {state.selectedTab === "participants" && (
        <EventParticipants
          event={props.event}
